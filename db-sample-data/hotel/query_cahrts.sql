DELETE FROM query_charts WHERE index = 'hotel';
...
VALUES (
    ...
    '觀傳局', 
    '臺北旅館業者的基本營業資訊', 
    '臺北市旅館分佈資料是一個實用的住宿業基礎資訊資料集，收錄了臺北市各行政區內旅宿業者的核心營業資料。資料內容包含六個主要欄位：旅宿名稱、營業地址、聯絡電話、房間數量、最低住宿價格及最高住宿價格', 
...
此資料集適合進行住宿市場分析、價格趨勢研究、區域發展評估等應用。研究者可以透過分析房間數分佈了解各區域的住宿供給能力，透過價格資料探討不同區域的住宿成本差異，並結合地址資訊進行空間分析，了解臺北市住宿業的整體發展格局與區域特色。', 
    ...
    CURRENT_TIMESTAMP, 
    'map_legend', 
	$$SELECT unnest(array['旅館']) as name, 'circle' as type$$,
    'taipei'
);
...
VALUES (
    ...
    '觀傳局,新北市政府觀光旅遊局', 
    '雙北旅館業者的基本營業資訊', 
    '雙北旅館分佈資料是一個實用的住宿業基礎資訊資料集，收錄了臺北市與新北市各行政區內旅宿業者的核心營業資料。資料內容包含六個主要欄位：旅宿名稱、營業地址、聯絡電話、房間數量、最低住宿價格及最高住宿價格', 
    '這份資料集的特色在於其資訊的實用性與完整性。透過地址資訊可了解各旅宿的地理分佈狀況，房間數量反映了各業者的營運規模，而價格區間則提供了市場定位與消費水準的重要指標。消費者可以根據預算需求快速篩選合適的住宿選項，業者則能透過價格比較了解市場競爭態勢。
此資料集適合進行住宿市場分析、價格趨勢研究、區域發展評估等應用。研究者可以透過分析房間數分佈了解各區域的住宿供給能力，透過價格資料探討不同區域的住宿成本差異，並結合地址資訊進行空間分析，了解臺北市住宿業的整體發展格局與區域特色。', 
