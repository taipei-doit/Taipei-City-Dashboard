...
isochrone_default	\N	{105}	{"mode": "byParam", "byParam": {"xParam": "name", "yParam": null}}	static	\N	\N	\N	臺北市都市智慧中心	顯示大眾運輸等時圈	顯示從指定地點出發，在不同時間門檻內搭乘公車、捷運、火車可到達的範圍。	用於交通可達性分析、通勤時間評估與都市規劃參考	{}	{TUIC}	2026-04-30 05:35:38.223872+00	2026-04-30 05:35:38.223872+00	map_legend	SELECT unnest(ARRAY['15分鐘', '30分鐘', '60分鐘', '90分鐘', '120分鐘']) AS name, 'fill' AS type	\N	taipei
isochrone_default	\N	{105}	{"mode": "byParam", "byParam": {"xParam": "name", "yParam": null}}	static	\N	\N	\N	臺北市都市智慧中心	顯示大眾運輸等時圈	顯示從指定地點出發，在不同時間門檻內搭乘公車、捷運、火車可到達的範圍。	用於交通可達性分析、通勤時間評估與都市規劃參考	{}	{TUIC}	2026-04-30 05:35:45.998295+00	2026-04-30 05:35:45.998295+00	map_legend	SELECT unnest(ARRAY['15分鐘', '30分鐘', '60分鐘', '90分鐘', '120分鐘']) AS name, 'fill' AS type	\N	metrotaipei
\.
