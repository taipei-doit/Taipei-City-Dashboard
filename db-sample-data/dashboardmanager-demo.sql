...
hazard_water_counts	{#0072E3,#66B3FF,#80FFFF}	{ColumnChart,BarPercentChart}	里
narrow_alley_agg_town	{#F75000}	{ColumnChart}	區
\.
...
302	hazard_water_counts	降雨淹水模擬圖
301	narrow_alley_agg_town	狹小巷弄程度分布
\.
...
hazard_water_counts	\N	\N	\N	static	\N	\N	\N	市政府	顯示雙北地區水災易淹水地點統計數量。	顯示雙北地區（臺北市與新北市）水災易淹水地點的統計數量，提供各行政區域內的淹水風險評估。此資料有助於了解雙北地區在極端氣候或豪雨情況下的淹水潛在風險，並為防災規劃、應急管理及基礎設施建設提供參考依據。透過這些數據，政府機關可針對高風險區域進行優先整治，提升城市防洪排水能力，保障民眾安全。	使用於防災規劃、城市基礎設施建設及應急管理，雙北地區淹水地點統計數據可協助政府機關掌握各行政區域的淹水風險分布。此指標適用於評估不同區域在極端氣候下的脆弱性，有助於制定針對性的防洪排水措施與基礎設施改善計畫。此外，企業亦可依據此數據進行市場分析，針對高風險區域設計防災產品與服務，強化區域經營策略的精準度與效益。此資料為雙北區域在防災與城市發展上的重要基礎依據。	{https://data.taipei/dataset/detail?id=1e0c58e9-6aa5-4acb-a5a1-f60bacad60f3,https://data.ntpc.gov.tw/datasets/8308ab58-62d1-424e-8314-24b65b7ab492}	{doit,ntpc}	2024-11-28 05:56:00+00	2025-03-20 01:33:28.634747+00	time	CREATE TABLE hazard_water_counts AS SELECT category AS x_axis, COUNT(*) AS y_axis, hazard_class AS data FROM hazard_water GROUP BY category, hazard_class	\N	metrotaipei
narrow_alley_agg_town	\N	\N	\N	static	\N	\N	\N	市政府	顯示雙北地區巷弄寬度統計。	顯示雙北地區（臺北市與新北市）巷弄寬度的統計數據，提供各行政區域內巷弄的平均寬度與分布情況。此資料有助於了解雙北地區在城市規劃、交通管理及公共安全等方面的巷弄特性，並為相關政策制定提供參考依據。透過這些數據，政府機關可針對狹窄巷弄進行優先整治，提升城市交通流暢度與居民生活品質。	使用於城市規劃、交通管理及公共安全，雙北地區巷弄寬度統計數據可協助政府機關掌握各行政區域的巷弄特性。此指標適用於評估不同區域在交通流量、緊急救援及公共設施佈局上的需求，有助於制定針對性的改善措施與基礎設施建設計畫。此外，企業亦可依據此數據進行市場分析，針對特定區域設計產品與服務，強化區域經營策略的精準度與效益。此資料為雙北區域在城市發展與交通管理上的重要基礎依據。	{https://data.taipei/dataset/detail?id=1e0c58e9-6aa5-4acb-a5a1-f60bacad60f3,https://data.ntpc.gov.tw/datasets/8308ab58-62d1-424e-8314-24b65b7ab492}	{doit,ntpc}	2024-11-28 05:56:00+00	2025-03-20 01:33:28.634747+00	time	SELECT town AS x_axis,size_counts AS y_axis FROM narrow_alley_agg_town_tp ORDER BY ARRAY_POSITION(ARRAY['士林區','大安區','文山區','松山區','南港區','大同區','中山區','內湖區','北投區','中正區','萬華區','信義區','板橋區','三重區','中和區','永和區','新莊區','新店區','樹林區','鶯歌區','三峽區','淡水區','汐止區','瑞芳區','土城區','蘆洲區','五股區','泰山區','林口區','深坑區','石碇區','坪林區','三芝區','石門區','八里區','平溪區','雙溪區','貢寮區','金山區','萬里區','烏來區'],town)	\N	metrotaipei
emergency_agg_villa	\N	\N	\N	static	\N	\N	\N	市政府	關於雙北狹小巷弄的分布。	顯示雙北地區（臺北市與新北市）巷弄寬度的統計數據，提供各行政區域內巷弄的平均寬度與分布情況。此資料有助於了解雙北地區在城市規劃、交通管理及公共安全等方面的巷弄特性，並為相關政策制定提供參考依據。透過這些數據，政府機關可針對狹窄巷弄進行優先整治，提升城市交通流暢度與居民生活品質。	使用於城市規劃、交通管理及公共安全，雙北地區巷弄寬度統計數據可協助政府機關掌握各行政區域的巷弄特性。此指標適用於評估不同區域在交通流量、緊急救援及公共設施佈局上的需求，有助於制定針對性的改善措施與基礎設施建設計畫。此外，企業亦可依據此數據進行市場分析，針對特定區域設計產品與服務，強化區域經營策略的精準度與效益。此資料為雙北區域在城市發展與交通管理上的重要基礎依據。	{https://data.taipei/dataset/detail?id=1e0c58e9-6aa5-4acb-a5a1-f60bacad60f3,https://data.ntpc.gov.tw/datasets/8308ab58-62d1-424e-8314-24b65b7ab492}	{doit,ntpc}	2024-11-28 05:56:00+00	2025-03-20 01:33:28.634747+00	time	WITH const_order AS (SELECT ARRAY['士林區','大安區','文山區','松山區','南港區','大同區','中山區','內湖區','北投區','中正區','萬華區','信義區','板橋區','三重區','中和區','永和區','新莊區','新店區','樹林區','鶯歌區','三峽區','淡水區','汐止區','瑞芳區','土城區','蘆洲區','五股區','泰山區','林口區','深坑區','石碇區','坪林區','三芝區','石門區','八里區','平溪區','雙溪區','貢寮區','金山區','萬里區','烏來區'] AS towns),base AS (SELECT town AS x_axis,CASE WHEN capacity<100 THEN '容留100以下' WHEN capacity BETWEEN 100 AND 999 THEN '容留100-1000' WHEN capacity BETWEEN 1000 AND 4999 THEN '容留1000-5000' ELSE '容留5000以上' END AS y_axis FROM emergency_agg_villa＿tp),agg AS (SELECT x_axis,y_axis,COUNT(*) AS data FROM base GROUP BY x_axis,y_axis) SELECT x_axis,y_axis,data FROM agg ORDER BY ARRAY_POSITION((SELECT towns FROM const_order),x_axis),CASE WHEN y_axis='容留100以下' THEN 1 WHEN y_axis='容留100-1000' THEN 2 WHEN y_axis='容留1000-5000' THEN 3 ELSE 4 END	\N	metrotaipei
\.
