...
source: "https://test-citydashboard.taipei/documentation/back-end/users-roles-groups-db"
author:
published:
created: 2026-04-24
...
`v3.0.0` Added public groups for Taipei (name=taipei) and Metro Taipei (name=metrotaipei).

## auth\_user\_group\_roles
...
[auto\_fix\_highEdit this Page on Github](https://github.com/taipei-doit/Taipei-City-Dashboard-Documentation/edit/main/src/assets/articles/back-end-en/users-roles-groups-db.md)