...
source: "https://test-citydashboard.taipei/documentation/back-end/go-backend"
author:
published:
created: 2026-04-24
...
##### [後端客製化指南](https://www.youtube.com/watch?v=LRQ61aLv-S4)
...
The router is stored in `/app/router/router.go`. It contains all the routes for the application. More information will be provided on the available routes in this application in [the section after next](https://test-citydashboard.taipei/documentation/back-end/authentication-apis).
...
Controllers are stored in `/app/controllers`. These controllers handle authentication and the business logic of the application. More information will be provided on the available controllers in this application in [the section after next](https://test-citydashboard.taipei/documentation/back-end/authentication-apis).
...
[auto\_fix\_highEdit this Page on Github](https://github.com/taipei-doit/Taipei-City-Dashboard-Documentation/edit/main/src/assets/articles/back-end-en/go-backend.md)