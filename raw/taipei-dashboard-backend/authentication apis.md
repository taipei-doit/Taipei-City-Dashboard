...
source: "https://test-citydashboard.taipei/documentation/back-end/authentication-apis"
author:
published:
created: 2026-04-24
...
The email and password to use are the ones you filled into the.env file when first setting up the project. For more information, please refer to [this previous article](https://test-citydashboard.taipei/documentation/back-end/project-setup).
...
[auto\_fix\_highEdit this Page on Github](https://github.com/taipei-doit/Taipei-City-Dashboard-Documentation/edit/main/src/assets/articles/back-end-en/authentication-apis.md)