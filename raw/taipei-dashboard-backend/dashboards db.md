...
source: "https://test-citydashboard.taipei/documentation/back-end/dashboards-db"
author:
published:
created: 2026-04-24
...
More information on front-end requirements for the `dashboards` table can be found in the [here](https://test-citydashboard.taipei/documentation/front-end/introduction-to-dashboards).
...
[auto\_fix\_highEdit this Page on Github](https://github.com/taipei-doit/Taipei-City-Dashboard-Documentation/edit/main/src/assets/articles/back-end-en/dashboards-db.md)