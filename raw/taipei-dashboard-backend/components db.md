...
source: "https://test-citydashboard.taipei/documentation/back-end/components-db"
author:
published:
created: 2026-04-24
...
##### [組件概述](https://www.youtube.com/watch?v=DpYPQY_6adc)

###### Introduction to Components

play\_circle

##### [組件圖表設定](https://www.youtube.com/watch?v=u0lUkc-NJ4E)

###### Chart Config

play\_circle

##### [組件地圖設定](https://www.youtube.com/watch?v=08ynRI3dPvk)

###### Map Config

play\_circle

##### [組件地圖篩選設定](https://www.youtube.com/watch?v=Tqh-ArEoYq4)
...
Three tables are used to store the configurations of dashboard components. When joined, the tables provide the complete [component config](https://test-citydashboard.taipei/documentation/front-end/introduction-to-components) required by the front-end.
...
**Columns of Note:** More information on front-end requirements for the `components` table can be found in the [here](https://test-citydashboard.taipei/documentation/front-end/introduction-to-components).

`v3.0.0` To support multiple cities, a single Component (component name) can have different QueryCharts (component information) for each city, with an index used for association.
...
`map_config_ids` is used solely for the purpose of joining the `components` and `component_maps` tables; `query_chart` and `query_history` store the SQL queries used to retrieve data for the chart and history components respectively. More information on the queries will be disclosed in the [component data APIs article](https://test-citydashboard.taipei/documentation/back-end/component-data-apis).

`v3.0.0` The "City" field is required. The currently available values are `taipei` and `metrotaipei`.
...
More information on front-end requirements for the `component_charts` table can be found in the [here](https://test-citydashboard.taipei/documentation/front-end/supported-chart-types).
...
More information on front-end requirements for the `component_maps` table can be found in the [here](https://test-citydashboard.taipei/documentation/front-end/supported-map-types).

[auto\_fix\_highEdit this Page on Github](https://github.com/taipei-doit/Taipei-City-Dashboard-Documentation/edit/main/src/assets/articles/back-end-en/components-db.md)