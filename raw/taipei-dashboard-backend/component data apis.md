...
source: "https://test-citydashboard.taipei/documentation/back-end/component-data-apis"
author:
published:
created: 2026-04-24
...
Query strings can be any valid SQL query string that can be executed by the `dashboard` database. In addition, the query strings can also contain placeholders (`%s`) that will be replaced by specified time ranges (if specified in [the component config](https://test-citydashboard.taipei/documentation/front-end/introduction-to-components)) to query data within a specific time frame. The values of the placeholders are automatically generated by the front-end.
...
> #### Tip - 1
> 
> We recommend that you familiarize yourself with the [chart data article](https://test-citydashboard.taipei/documentation/front-end/chart-data) in the front-end docs before reading this section.
...
The `percent` query type shares the same format as the `three_d` query type, but with some additional restrictions on the data values. Refer to the [chart data article](https://test-citydashboard.taipei/documentation/front-end/chart-data) in the front-end docs for more information.
...
| --- | --- |
| Permissions | `Guest` |
| Query Params | `timefrom` ---- Start time for the query. Optional.   `timeto` -------- End time for the query. Optional. |
...
| --- | --- |
| Permissions | `Guest` |
| Query Params | `timefrom` ---- Start time for the query. Required.   `timeto` -------- End time for the query. Required. |
...
[auto\_fix\_highEdit this Page on Github](https://github.com/taipei-doit/Taipei-City-Dashboard-Documentation/edit/main/src/assets/articles/back-end-en/component-data-apis.md)