---
title: "文件｜臺北城市儀表板"
source: "https://test-citydashboard.taipei/documentation/front-end/introduction-to-dashboards"
author:
published:
created: 2026-04-24
...
[`GET` `/api/v1/dashboard`](https://test-citydashboard.taipei/documentation/back-end/dashboard-apis) [`DB` `dashboardmanager.dashboards`](https://test-citydashboard.taipei/documentation/back-end/dashboards-db)
