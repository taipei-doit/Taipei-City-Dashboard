---
title: "文件｜臺北城市儀表板"
source: "https://test-citydashboard.taipei/documentation/front-end/custom-styling"
author:
published:
created: 2026-04-24
...
如果您對地圖（Mapbox）的樣式感興趣，請參考 [客製化地圖](https://test-citydashboard.taipei/documentation/front-end/custom-maps) 文章。

> #### 警告 - 1
> 
> 協作者請注意，在修改本專案時，有一些全域和局部樣式是不允許被修改的。另外，我們也制定了 [設計指南](https://test-citydashboard.taipei/documentation/front-end/design-guide) ，如果您希望對本專案貢獻新元素，應遵循該指南。
