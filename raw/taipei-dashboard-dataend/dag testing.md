...
source: "https://test-citydashboard.taipei/documentation/data-end/dag-test"
author:
published:
created: 2026-04-24
...
> #### Warning - 1
> 
> 請務必確認你已根據 [下載並設定專案](https://test-citydashboard.taipei/documentation/data-end/project-setup) 章節部屬成功。
...
> #### Information - 1
> 
> `_mtime` 是該列資料的最後修改時間，欄位說明可見上一章 [資料流表格](https://test-citydashboard.taipei/documentation/data-end/dag-table) 。

[auto\_fix\_highEdit this Page on Github](https://github.com/taipei-doit/Taipei-City-Dashboard-Documentation/edit/main/src/assets/articles/data-end-en/dag-test.md)