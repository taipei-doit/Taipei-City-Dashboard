...
source: "https://test-citydashboard.taipei/documentation/data-end/global-config"
author:
published:
created: 2026-04-24
...
Airflow Connections 可以快速添加可連接的資料庫，相關設定已在 [下載並設定專案](https://test-citydashboard.taipei/documentation/data-end/project-setup) 章節設置完成。
...
必要的資訊已在 [下載並設定專案](https://test-citydashboard.taipei/documentation/data-end/project-setup) 章節設置完成，可以透過 Airflow 網頁介面查看相關設定。
...
[auto\_fix\_highEdit this Page on Github](https://github.com/taipei-doit/Taipei-City-Dashboard-Documentation/edit/main/src/assets/articles/data-end-en/global-config.md)