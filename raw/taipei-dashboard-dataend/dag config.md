...
source: "https://test-citydashboard.taipei/documentation/data-end/dag-config"
author:
published:
created: 2026-04-24
...
在 [撰寫Python程式碼](https://test-citydashboard.taipei/documentation/data-end/dag-code) 的宣告變數部分使用了許多動態變數，變數的來源除了全域共用的變數外，有一大部分為每個 DAG 獨立的設定檔。
...
[auto\_fix\_highEdit this Page on Github](https://github.com/taipei-doit/Taipei-City-Dashboard-Documentation/edit/main/src/assets/articles/data-end-en/dag-config.md)