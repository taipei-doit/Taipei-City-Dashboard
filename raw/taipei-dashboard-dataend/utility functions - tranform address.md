...
source: "https://test-citydashboard.taipei/documentation/data-end/utils-transform-address"
author:
published:
created: 2026-04-24
...
tags:
  - "clippings"
---
## Utility Functions - Transform Address
...
### \-函式 main\_process(addr\_cleaned)

辨識並切分地址，同時提供程式判斷信心等級。

### \-函式 save\_data(addr, addr\_cleaned, standard\_addr\_list)
...
[auto\_fix\_highEdit this Page on Github](https://github.com/taipei-doit/Taipei-City-Dashboard-Documentation/edit/main/src/assets/articles/data-end-en/utils-transform-address.md)