...
source: "https://test-citydashboard.taipei/documentation/data-end/utils-generate-sql"
author:
published:
created: 2026-04-24
...
tags:
  - "clippings"
---
## Utility Functions - Create Table
...
> #### Information - 1
> 
> 有關本專案的標準表格，請參閱 [資料流表格](https://test-citydashboard.taipei/documentation/data-end/dag-table) 。

### \-函式 \_show\_smaple\_column\_type()

此函式無作用，僅供參考常使用的欄位類型。

### \-函式 generate\_sql\_to\_delete\_db\_table(table\_name, col\_map)
...
### \-函式 generate\_sql\_to\_delete\_db\_table(table\_name)
...
[auto\_fix\_highEdit this Page on Github](https://github.com/taipei-doit/Taipei-City-Dashboard-Documentation/edit/main/src/assets/articles/data-end-en/utils-generate-sql.md)