...
source: "https://test-citydashboard.taipei/documentation/data-end/utils-transform-time"
author:
published:
created: 2026-04-24
...
tags:
  - "clippings"
---
## Utility Functions - Transform Time
...
### \-函式 convert\_str\_to\_time\_format(time\_column)
...
### \-函式 omit\_chinese\_string\_in\_time(x)
...
[auto\_fix\_highEdit this Page on Github](https://github.com/taipei-doit/Taipei-City-Dashboard-Documentation/edit/main/src/assets/articles/data-end-en/utils-transform-time.md)