...
source: "https://test-citydashboard.taipei/documentation/data-end/utils-extract"
author:
published:
created: 2026-04-24
...
### \-函式 get\_data\_taipei\_api(rid, output\_format)
...
### get\_kml(url, dag\_id, from\_crs)
...
### \-函式 get\_shp\_file(url, dag\_id, from\_crs)
...
### \-函式 get\_moenv\_json\_data(dataset\_code)
...
### \-函式 get\_tdx\_data(url, output\_format)
...
### \-函式 get\_json\_file(url, dag\_id, output\_format)
...
### \-函式 get\_geojson\_file(url, dag\_id, from\_crs)
...
### \-函式 get\_data\_taipei\_file\_last\_modified\_time(page\_id, rank)
...
### \-函式 get\_data\_taipei\_page\_change\_time(page\_id, rank)
...
### \-函式 download\_file(file\_name, url)
...
### \-函式 unzip\_file\_to\_target\_folder(zip\_file, unzip\_path)
...
[auto\_fix\_highEdit this Page on Github](https://github.com/taipei-doit/Taipei-City-Dashboard-Documentation/edit/main/src/assets/articles/data-end-en/utils-extract.md)