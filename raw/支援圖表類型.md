---
title: "文件｜臺北城市儀表板"
source: "https://test-citydashboard.taipei/documentation/front-end/supported-chart-types"
author:
published:
created: 2026-04-24
...
##### [組件圖表設定](https://www.youtube.com/watch?v=MuCqlgBipzo)

###### Chart Config

play\_circle

##### [組件圖表設定 3.0](https://www.youtube.com/watch?v=m_veuedK7h0)

###### Chart Config 3.0

## 圖表配置

為了正確地呈現圖表，需要將圖表配置填入組件配置中的 `chart_config` 參數，詳細內容請參閱 [這篇先前的文章](https://test-citydashboard.taipei/documentation/front-end/introduction-to-components#component-configuration) 。完整的圖表配置(Object)如下所示。
...
[`DB` `dashboardmanager.component_charts`](https://test-citydashboard.taipei/documentation/back-end/components-db)
