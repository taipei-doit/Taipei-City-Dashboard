---
title: "文件｜臺北城市儀表板"
source: "https://test-citydashboard.taipei/documentation/front-end/chart-data"
author:
published:
created: 2026-04-24
...
##### [圖表與歷史資料格式](https://www.youtube.com/watch?v=1OARa32Ay3o)

###### Chart and History Data

play\_circle

##### [新增圖表樣式 文字單位圖 3.0](https://www.youtube.com/watch?v=hRoRASJOnPo)

###### New version of chart TextUnitChart3.0

## 支援的資料類型

本專案目前支援 5 種圖表資料類型。每種資料類型都有預定的格式並支援一組圖表。如要了解更多有關各圖表類型的資訊，請參考 [下一篇文章](https://test-citydashboard.taipei/documentation/front-end/supported-chart-types) 。

[`GET` `/api/v1/component/:id/chart`](https://test-citydashboard.taipei/documentation/back-end/component-data-apis) [`DB` `dashboardmanager.components`](https://test-citydashboard.taipei/documentation/back-end/components-db)
...
> #### 資訊 - 2
> 
> 有關捷運行駛圖的 key-value 格式，請參 [下一篇文章](https://test-citydashboard.taipei/documentation/front-end/supported-chart-types#metro-chart) 。
...
> #### 資訊 - 3
> 
> 有關指標圖的 key-subcategory-value 格式，和文字單位圖的具體應用方式請參 [下一篇文章](https://test-citydashboard.taipei/documentation/front-end/supported-chart-types) 。
