...
TPE_XLSX = os.path.join(BASE, "Taipei-City-Dashboard-DE/dags/utils/opendata/溯源餐廳/台北市溯源餐廳.xlsx")
NTPC_XLSX = os.path.join(BASE, "Taipei-City-Dashboard-DE/dags/utils/opendata/溯源餐廳/新北市溯源餐廳.xlsx")
TPE_GEOJSON = os.path.join(BASE, "Taipei-City-Dashboard-FE/public/mapData/traceable_restaurant_tpe.geojson")
NTPC_GEOJSON = os.path.join(BASE, "Taipei-City-Dashboard-FE/public/mapData/traceable_restaurant_ntpc.geojson")
