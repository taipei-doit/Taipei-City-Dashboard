...
import ForeignRestaurantMapChart from "./components/ForeignRestaurantMapChart.vue";
...
function returnChartComponent(name, svg) {
	...
	case "ForeignRestaurantMapChart":
		return svg ? MapLegendSvg : ForeignRestaurantMapChart;
	default:
		return svg ? MapLegendSvg : MapLegend;
	}
}
