...
// 雙色支援：color[0] 給臺北、color[1] 給新北（缺 color[1] 時 fallback 到 color[0]）
function districtColor(cityValue) {
	if (cityValue === "newtaipei") {
		return props.chart_config.color[1] || props.chart_config.color[0];
	}
    ...
    <div class="districtchart-title">
      ...
      <div class="districtchart-title-legend">
        ...
        <div
          ...
          :title="props.chart_config.color[1] ? '臺北市' : ''"
        />
        <div
          v-if="props.chart_config.color[1] && cityName !== '臺北市'"
          :style="{ backgroundColor: props.chart_config.color[1] }"
          title="新北市"
        />
        <p>少</p>
      </div>
