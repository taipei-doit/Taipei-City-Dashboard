...
/** 氣溫等不可加總的指標可關閉「總合」區塊 */
const showDistrictSum = ref(false);
...
const districtData = computed(() => {
	...
	output.chartMin = chartMin;
	output.chartMax = chartMax;

	return output;
});

const MIN_DISTRICT_FILL = 0.12;

/** 依「本次資料區間」做 min–max 正規化透明度，數值只差 0.x（如氣溫）仍看得出漸層 */
function districtFillOpacity(name) {
	const d = districtData.value;
	const v = d[name];

	if (!(typeof v === "number" && Number.isFinite(v))) {
		return MIN_DISTRICT_FILL;
	}

	const minV = d.chartMin;
	const maxV = d.chartMax;
	if (
		minV === 0 &&
		maxV === 0 &&
		d.highest === 0
	...
	return MIN_DISTRICT_FILL + (1 - MIN_DISTRICT_FILL) * clamped;
}
...
<template>
  ...
  >
    <div class="districtchart-title">
      <template v-if="showDistrictSum">
        <h5>總合</h5>
        <h6>{{ districtData.sum }} {{ chart_config.unit }}</h6>
      </template>
      <button
        type="button"
        class="districtchart-sum-toggle"
        :aria-pressed="showDistrictSum"
        @click="showDistrictSum = !showDistrictSum"
      >
        {{ showDistrictSum ? "隱藏總合" : "顯示總合" }}
      </button>
      ...
      >
        ...
        >
          <path
            ...
            :fill-opacity="districtFillOpacity('新莊區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('淡水區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('汐止區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('板橋區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('三重區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('樹林區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('土城區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('蘆洲區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('中和區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('永和區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('新店區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('鶯歌區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('三峽區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('瑞芳區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('五股區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('泰山區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('林口區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('深坑區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('石碇區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('坪林區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('三芝區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('石門區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('八里區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('平溪區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('雙溪區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('貢寮區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('金山區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('萬里區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('烏來區')"
            :fill="districtColor"
        ...
        >
          <path
            ...
            :fill-opacity="districtFillOpacity('北投區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('士林區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('內湖區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('中山區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('大同區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('中正區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('萬華區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('大安區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('信義區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('松山區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('南港區')"
            :fill="districtColor"
          ...
          <path
            ...
            :fill-opacity="districtFillOpacity('文山區')"
            :fill="districtColor"
...
.districtchart {
	...
	&-sum-toggle {
		...
		border: 1px solid color-mix(in srgb, var(--color-complement-text) 35%, transparent);
		border-radius: 4px;
		cursor: pointer;

		&:hover {
			border-color: color-mix(in srgb, var(--color-complement-text) 55%, transparent);
		}
	}
