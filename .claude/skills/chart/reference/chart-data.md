...
```json
{
 ...
 "data": [
  ...
  {
   "name": "中低收",
   "data": [1740, 754, 2204, 561, 1170, 980, 921, 1423, 1508, 518, 2540, 1215]
  },
  {
   "name": "身障補助",
...
支援的圖表類型： 縱向長條圖(ColumnChart)、長條圖(%)(BarPercentChart)、雷達圖(RadarChart)、行政區圖(DistrictChart)、熱力圖(HeatmapChart)、極座標圖(PolarAreaChart)、指標圖(IndicatorChart) 、文字單位圖(TextUnitChart)
...
來源：https://citydashboard.taipei/documentation/front-end/chart-data
