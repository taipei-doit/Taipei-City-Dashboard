...
def _internal_medicine_institutions_ntpe(**kwargs):
    # === Imports(全部寫在函式內)===
    import pandas as pd
    ...
    raw_data = pd.DataFrame(
        NewTaipeiAPIClient("e8244d31-e0e5-459d-87ba-3c188706fbee").get_all_data(size=1000)
    )
    # === Transform ===
...
dag = CommonDag(proj_folder="proj_new_taipei_city_dashboard", dag_folder="internal_medicine_institutions_ntpe")
dag.create_dag(etl_func=_internal_medicine_institutions_ntpe)
