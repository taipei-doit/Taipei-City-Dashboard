"""Test for food_bank_contacts DAG.

驗證 data_infos.source 可達且回傳合理資料。**不**需要 Airflow / Postgres。

Run from DAG folder:
    python test_food_bank_contacts.py
或從 toolkit:
...
# 注意:DAG 內用 get_current_rid_from_page_id 動態解析,此處僅供可達性驗證
RID = "e38afd26-9ba8-42fa-8044-8e1571eecf83"
