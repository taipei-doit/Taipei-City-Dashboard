...
def _internal_medicine_institutions(**kwargs):
    # === Imports(全部寫在函式內)===
    import pandas as pd
    ...
    # === Extract ===
    raw_data = pd.DataFrame(get_data_taipei_api("da296984-a858-45d2-ba8b-866cf133bd23"))
    # === Transform ===
...
dag = CommonDag(proj_folder="proj_city_dashboard", dag_folder="internal_medicine_institutions")
dag.create_dag(etl_func=_internal_medicine_institutions)
