...
def _general_medicine_institutions(**kwargs):
    # === Imports(全部寫在函式內)===
    import pandas as pd
    ...
    # === Extract ===
    raw_data = pd.DataFrame(get_data_taipei_api("50f3261b-da8e-4300-abcb-09a6b7aa2230"))
    # === Transform ===
...
dag = CommonDag(proj_folder="proj_city_dashboard", dag_folder="general_medicine_institutions")
dag.create_dag(etl_func=_general_medicine_institutions)
