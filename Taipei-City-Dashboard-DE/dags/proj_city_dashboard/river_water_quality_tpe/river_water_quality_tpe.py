...
def _river_water_quality_tpe(**kwargs):
    import pandas as pd
    ...
    if raw_data.empty:
        raise ValueError("MOENV WQX_P_01 returned no Taipei records")
...
dag = CommonDag(
    ...
    dag_folder="river_water_quality_tpe",
)
dag.create_dag(etl_func=_river_water_quality_tpe)
