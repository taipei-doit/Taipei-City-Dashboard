...
def _family_medicine_institutions(**kwargs):
    # === Imports(全部寫在函式內)===
    import pandas as pd
    ...
    # === Extract ===
    raw_data = pd.DataFrame(get_data_taipei_api("1a6a6056-4649-48be-b071-fba88d025d10"))
    # === Transform ===
...
dag = CommonDag(proj_folder="proj_city_dashboard", dag_folder="family_medicine_institutions")
dag.create_dag(etl_func=_family_medicine_institutions)
